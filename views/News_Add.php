		...
		<form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('GlobalController/News_Add'); ?>" class="form-horizontal form12">
		 ...
		 <div class="row">
		    <div class="col-md-7">
				...
				<div class="col-md-12">
				    <input type="text" name="newsType" id="name"  class="form-control input-lg" value="" placeholder="News Title" />
				</div>
				<div class="col-md-12">
			     <h4 class="m-t-0">News Sub Title</h4>
				 </div>
				<div class="col-md-12">
				    <input type="text" name="subTitle" id="subTitle"  class="form-control input-md" value="" placeholder="News Sub Title" />
				</div>
                                 <div class="col-md-12">
				   <p></p>
