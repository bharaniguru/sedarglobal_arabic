            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body" id="form_validation">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('GlobalController/Sedarmaterial_Add'); ?>" class="form-horizontal form12">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="materialName" id="FeedbackTitle"  class="form-control input-lg" value="" placeholder="Material" />
                                    </div>
                                </div>
                            </div>
