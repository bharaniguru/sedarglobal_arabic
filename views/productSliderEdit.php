<div id="content" class="content">
	...
	<div class="col-md-12">
		...
		<div class="panel-body" id="form_validation">
		    <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('GlobalController/globalProductEdit/'.$getproductnow[0]['id']); ?>"" class="form-horizontal">
			<div class="row AdjustPadding" id="image1" style="padding-bottom:20px;" >
				...
				<?php foreach($getproductnow as $row)
				
				
				$image=$row['productSliderImage'];
				$title=$row['productSliderTitle'];
				$subtitle=$row['productSliderDescription'];
				$link=$row['productSliderLink'];
				  
				$common=explode(",",$image);
				$common1=explode(",",$title);
				$common2=explode(",",$subtitle);
				$common3=explode(",",$link);
				...
				<div class="col-md-4 ImageView AdjustPadding" style="padding-bottom:20px;">
				    <img src="<?php echo site_url('uploads/'.$common[$i]);?>" class="col-md-12 previewimage" id="dummy1" style="height: 185px;" >
					
					 <input type="file" id="preview" name="image[]" onchange="attachment(this);" >
					<input type="hidden" id="preview" name="oldimage[]" value="<?php echo $common[$i]?>" >
				    ...
				    <p></p>
				    <input type="text" class="form-control" name="sliderTitle[]" id="id" value="<?php echo $common1[$i]; ?>" placeholder="Slider Title">
				   <p></p>
				    <input type="text" class="form-control" name="subTitle[]" id="id" value="<?php echo $common2[$i]; ?>" placeholder="Slider Sub Title">
				  <p></p>
				    <input type="text" class="form-control" name="sliderLink[]" id="id" value="<?php echo $common3[$i]; ?>" placeholder="Slider link">                                
				</div>
				<?php }?>
			    </div>
			</div>
