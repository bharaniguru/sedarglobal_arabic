...
?>
	<div id="content" class="content">
		...
		<div class="panel-body" id="form_validation">
		  <form action="<?php echo base_url(); ?>GlobalController/cityAdder" class="form-horizontal"  id="form_validation" method="post" name="form_validation" enctype="multipart/form-data">
