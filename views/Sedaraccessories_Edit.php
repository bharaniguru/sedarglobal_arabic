            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body" id="form_validation">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('GlobalController/Sedaraccessories_Edit/'.$accessoriesrow[0]['id']); ?>" class="form-horizontal form12">
                            <legend>Choose the Categories to change</legend>
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="col-md-12">
                                       <h3 class="m-t-0">Material</h3>
                                    </div>
                                    <div class="col-md-12">
                                        <input type="text" name="AccessoriesName" id="FeedbackTitle"  class="form-control input-lg" value="<?php echo $accessoriesrow[0]['AccessoriesName'] ?>" placeholder="Material" />
                                    </div>
                                </div>
                            </div>
