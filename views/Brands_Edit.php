		...
		<div class="panel-body" id="">
		 <?php
		    foreach($BrandsEdit as $row)
				    ...
				    $BrandsEdit= $row['brandDescription'];
                                    $BrandsEdit= $row['bImage'];
                                    $BrandsEdit= explode(",", $BrandsEdit);
                                    $length = count($BrandsEdit);
                                    
				   ?>
		<form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('GlobalController/Brands_Edit/'.$row['id']); ?>" class="form-horizontal form12">
		 ...
		 <div class="row">
		    <div class="col-md-7">
				...
				<div class="col-md-12">
				    <input type="text" name="bName" id="bName"  class="form-control input-lg" value="<?php echo $row['bName']; ?>" placeholder="Brand Title" />
				</div>
				...
				<textarea id="brandDescription" name="brandDescription" placeholder="Enter your content here" cols="25" rows="5" class="ckeditor textarea form-control  textarea_middle required"><?php echo $row['brandDescription']; ?> </textarea>
				</div>
				...
				?>
                            <div class="col-md-4 col-sm-4 col-xs-12 ImageView AdjustPadding" style="padding-bottom:20px;"  >
                                ...
                                <img src="<?php echo site_url('uploads/'.$BrandsEdit[$i]);?>" class="col-md-12 previewimage " id="dummy1" style="height: 185px; width: 200px;" >
...
<!--				<input type="file" id="preview" name="image[]" class="col-md-12 "onchange="attachment(this);" >-->
			<div class="input-group" style="padding:10px;">
				...
				Browse<input type="file" id="preview" name="image[]" class="col-md-12 "onchange="attachment(this);" >
				 <input type="hidden" name="oldimage[]" value="<?php echo $BrandsEdit[$i]?>">
				</span>
				</span>
