	...
	<div id="content" class="content">
		...
		<form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('GlobalController/Faq_Add'); ?>" class="form-horizontal form12">
		 ...
		 <div class="row">
		    <div class="col-md-7">
				...
				<div class="col-md-12">
				    <input type="text" name="Faq_Title" id="aboutTitle"  class="form-control input-lg" value="" placeholder="Overview Title" />
				</div>
				...
				<div class="col-md-12">
				<textarea id="aboutDescription" name="Faq_Description" placeholder="Enter your content here" cols="25" rows="5" class="ckeditor textarea form-control  textarea_middle required"> </textarea>
				</div>
		    </div>
		</div>
